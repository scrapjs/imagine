'use strict';(function() {
  ...
  function s(a) {
    return J(a, escape, Array.prototype.slice.apply(arguments).slice(1))
  }
  function J(a, b, c) {
    ...
    if(isNaN(c = parseFloat(a))) {
      ...
      if("[" === a[0] && "]" === a[a.length - 1]) {
        ...
        for(var d = a.split(","), c = [], e = 0;e < d.length;e++) {
          d[e] = unescape(d[e]).trim(), c[e] = z(d[e], b)
        }
        return c
      }
      if("{" === a[0] && "}" === a[a.length - 1]) {
  ...
  function v(a, b) {
    if(a) {
      ...
      this.chunkArguments.push(A(unescape(c[2]), this.context));
      this.chunkTarget = this.context[this.chunkNames[0]];
      void 0 === this.chunkTarget && (this.chunkTarget = n[this.chunkNames[0]]);
      ...
      if(a = a.replace(c[0], "")) {
        for(var d = 10;(c = a.match(this.plainChunkRE) || a.match(this.keyChunkRE)) && d;) {
          this.chunkNames.push(unescape(c[1])), this.chunkArguments.push(A(unescape(c[2]), this.context)), a = a.replace(c[0], ""), d--
        }
      }
    }
  }
  function M(a, b) {
    this.context = h({}, n, b);
    var c = a.indexOf("(");
    0 < c ? (this.name = a.slice(0, c).trim(), this.params = A(a.slice(c).slice(1, -1), this.context)) : this.name = a.trim();
    this.fn = n.filters[this.name];
    this.fn || (console.error("no filter `" + this.name + "` found. `none` is used instead."), this.fn = I)
  }
  function F(a, b) {
    ...
    for(var e = 0;e < c.length;e++) {
      this.subjects.push(new B(c[e], this.nestedContext))
    }
    d || (d = "{{ repeat(" + this.subjects.length + ") }}");
    this.context.subjects = this.subjects;
    this.repeatEx = new p(d, this.context)
  }
  function B(a, b) {
  ...
  var l = ["\u2985", "\u2986"], O = /(?:'[^']*'|"[^"]*")/g, C = ["{{", "}}"], P = "applet base basefont frame frameset head isindex link meta noframes noscript object param script style title".split(" "), H = {}, n = {locale:"en_EN", utils:{refBrackets:l, extend:h, escapeWithin:s, unescapeWithin:function(a) {
    return J(a, unescape, Array.prototype.slice.apply(arguments).slice(1))
  }, escapeSymbols:y, unescapeSymbols:D, parseArguments:A}, any:r, "int":m, "float":function(a, b) {
    return void 0 === a ? q(!1) : void 0 === b ? q(a, !1) : q(a, b, !1)
  }, number:q, bool:function() {
    ...
    var c;
    H[a] ? (c = H[a], b && c.setContext(b)) : (c = new p(a, b), H[a] = c);
    return c.populate()
  }, none:I, populate:function(a) {
    return(new B(a)).populate()
  }, fixed:function(a, b) {
    a = a.toString();
    var c = a.length;
    ...
    return c
  }, filters:{}, Expression:p};
  window.imagine = n;
  p.defaults = {context:null, maxMultiplier:99};
  p.prototype = {setContext:function(a) {
    this.context = a
    ...
    for(a = u(a);null !== (b = a.match(this.reversiveDataRE)) && 99 > c;) {
      var d = new E(D(u(b[2]), "{}"), u(b[1]), this);
    ...
    return"string" === typeof a ? D(a, l) : a
  }, toString:function() {
  ...
  h(w.prototype, t.prototype, {parse:function(a) {
    ...
    for(var b = [], c, d = 0;a && 9999 > d;) {
      if(c = a.match(this.anyTokenRE)) {
        b.push(new L(c[1], c[2], this.expression))
      }else {
        if(c = a.match(this.dataTokenRE)) {
          b.push(new E(c[1], c[2], this.expression))
        }else {
          if(c = a.match(this.specSymbolTokenRE)) {
            /[1-9]/.test(c[1]) ? b.push(new K(~~c[1], c[2], this.expression)) : b.push(new x("\\" + c[1], c[2], this.expression))
          }else {
  ...
  h(K.prototype, t.prototype, {parse:function(a) {
    this.groupId = ~~a
  }, toString:function() {
  ...
  h(E.prototype, t.prototype, {maxRecursionDepth:5, techSymbols:"|,()", parse:function(a) {
    this.dataString = a = a.slice(2, -2).trim();
    a = s(a, "''", '""');
    var b = a.split("|");
    a = unescape(b[0]).trim();
    b = b.slice(1);
    this.source = z(a, this.expression.context);
    this.filters = [];
    for(a = 0;a < b.length;a++) {
      this.filters.push(new M(unescape(b[a]), this.expression.context))
    }
  }, toString:function() {
  ...
  h(L.prototype, t.prototype, {parse:function(a) {
    var b = a.match(/[^-]-[^-]/ig);
    if(b) {
  ...
  B.prototype = {dataRegExp:RegExp([C[0], "[ ]*([a-zA-Z_$@][a-zA-Z_$@.0-9]*)[^", C[0], C[1], "]*", C[1]].join(""), "ig"), parseDescriptor:function(a) {
    a.match(this.dataRegExp);
    return[{title:"", description:"", tagline:"", categories:[], tags:[], pubdate:"", author:"Person"}]
  }, recognize:function(a) {
    return a instanceof Array ? new F(a, this.context) : "string" === typeof a ? new p(a, this.context) : a instanceof Object ? this.recognizeObject(a) : a
  ...
  h(n.filters, {capitalize:G, capfirst:G, truncatechars:function(a, b, c) {
